...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"./pkg/apis/app/v1alpha1.PodSetSpec":   schema_pkg_apis_app_v1alpha1_PodSetSpec(ref),
		"./pkg/apis/app/v1alpha1.PodSetStatus": schema_pkg_apis_app_v1alpha1_PodSetStatus(ref),
	}
}
